<script lang="ts">
	...
	let action = 'https://geocoding-clientapis.biovision.digital/siac/climapi-open/v1/search?';
	$: switch ($api_key_preferences.use) {
		case 'commercial':
			action = `https://customer-geocoding-clientapis.biovision.digital/siac/climapi-open/v1/search?apikey=${$api_key_preferences.apikey}&`;
			break;
		case 'self_hosted':
			action = `${$api_key_preferences.self_host_server}/v1/search?`;
			break;
		default:
			action = 'https://geocoding-clientapis.biovision.digital/siac/climapi-open/v1/search?';
	}
...
<div class="col-12 py-5">
	...
	<p>
		The API endpoint <mark
			>https://geocoding-clientapis.biovision.digital/siac/climapi-open/v1/search</mark
		> accepts a search term and returns a list of matching locations. URL parameters are listed below:
	</p>
...
`}
	...
	*Note: All IDs can be can be resolved via the API endpoint<a
		href="https://geocoding-clientapis.biovision.digital/siac/climapi-open/v1/get?id=2950159"
		target="_new"
		>https://geocoding-clientapis.biovision.digital/siac/climapi-open/v1/get?id=2950159</a
	>
