<script lang="ts">
	...
	let base = 'https://clientapis.biovision.digital/siac/climapi-open/v1/elevation?';
	$: switch ($api_key_preferences.use) {
		case 'commercial':
			base = `https://customer-clientapis.biovision.digital/siac/climapi-open/v1/elevation?apikey=${$api_key_preferences.apikey}&`;
			break;
		case 'self_hosted':
			base = `${$api_key_preferences.self_host_server}/v1/elevation?`;
			break;
		default:
			base = 'https://clientapis.biovision.digital/siac/climapi-open/v1/elevation?';
	}
...
<form
	...
	method="get"
	target="container"
	action="https://clientapis.biovision.digital/siac/climapi-open/v1/elevation"
>
	<div class="row">
			...
			<tbody>
				<tr>
					...
					<td>
						...
						<a
							href="https://clientapis.biovision.digital/siac/climapi-open/v1/elevation?latitude=52.52,48.85&longitude=13.41,2.35"
